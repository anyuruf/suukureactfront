...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="suukuWebfrontApp.productCategory.delete.question">
        <Translate contentKey="suukuWebfrontApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
