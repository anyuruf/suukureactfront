...
export const ProductOrderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="suukuWebfrontApp.productOrder.delete.question">
        <Translate contentKey="suukuWebfrontApp.productOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
