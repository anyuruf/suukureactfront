...
export const OrderItemDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="suukuWebfrontApp.orderItem.delete.question">
        <Translate contentKey="suukuWebfrontApp.orderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
