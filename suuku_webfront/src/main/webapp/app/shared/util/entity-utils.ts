...
export const cleanEntity = (entity: Entity): Entity => {
  const keysToKeep: string[] = Object.keys(entity).filter(
    (k: string) => !(entity[k] instanceof Object) || (entity[k].id !== '' && entity[k].id !== -1),
  );
